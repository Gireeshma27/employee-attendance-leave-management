    ...
    <div className="w-full">
      ...
      <div className="relative group">
        ...
        <input
          ...
          className={`w-full ${Icon ? "pl-11" : "px-3.5"} py-2.5 bg-white border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-sm text-slate-800 placeholder:text-slate-400 ${
            error
