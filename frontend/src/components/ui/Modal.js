...
=======
          className={`relative bg-white rounded-lg shadow-xl w-full max-w-2xl transition-all duration-300 ${
...
>>>>>>> 5ac8cd0c0ea525059ca23962c6bb20b870e5ce3b
          ...
          {/* Content */}
<<<<<<< HEAD
          <div className="px-4 md:px-6 py-4 max-h-[calc(100vh-200px)] overflow-y-auto">{children}</div>
=======
