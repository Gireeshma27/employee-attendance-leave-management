...
import { Mail, Phone, MapPin, Calendar, Edit2, Briefcase, User } from 'lucide-react';
            ...
            <CardContent className="pt-8">
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 mb-8 pb-8 border-b border-slate-100">
                ...
                <div className="text-center sm:text-left">
                  ...
                  <p className="text-gray-500 mt-1">{profileData.role || 'Employee'}</p>
                  <p className="text-sm text-gray-400 mt-1">{profileData.employeeId || '-'}</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-5">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-xs text-gray-400 uppercase tracking-wider font-medium">Department</p>
                      <p className="text-gray-900 mt-1">{profileData.department || 'Not assigned'}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-5">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900 mt-1">{profileData.role || 'Employee'}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-xs text-gray-400 uppercase tracking-wider font-medium">Employee ID</p>
                      <p className="text-gray-900 mt-1">{profileData.employeeId || '-'}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900 mt-1">
                        <span className={`inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-xs font-medium ${profileData.isActive ? 'bg-green-50 text-green-700' : 'bg-red-50 text-red-700'}`}>
                          <span className={`w-1.5 h-1.5 rounded-full ${profileData.isActive ? 'bg-green-500' : 'bg-red-500'}`}></span>
