    ...
    <DashboardLayout role="admin">
      <div className="space-y-6 md:space-y-8">
        ...
        <div>
          ...
          <p className="text-xs sm:text-sm md:text-sm text-slate-500 mt-1">System-wide leave request overview</p>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4">
            ...
            <Card>
              <CardContent className="pt-4 md:pt-6 text-center">
                ...
                <p className="text-2xl md:text-3xl font-semibold text-yellow-600 mt-1 md:mt-2">
                  {stats.totalPending}
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="pt-4 md:pt-6 text-center">
                ...
                <p className="text-2xl md:text-3xl font-semibold text-green-600 mt-1 md:mt-2">
                  {stats.totalApproved}
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="pt-4 md:pt-6 text-center">
                ...
                <p className="text-2xl md:text-3xl font-semibold text-red-600 mt-1 md:mt-2">
                  {stats.totalRejected}
                </p>
              </CardContent>
            </Card>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 py-2">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className={`flex items-center justify-center gap-2 px-4 py-2.5 border rounded-xl bg-white shadow-sm transition-colors ${
                  activeFilterCount > 0
                ...
                <table className="w-full text-xs sm:text-sm">
                  <thead className="border-b border-slate-200">
                    <tr className="text-slate-500">
                      <th className="text-left py-3 px-2 sm:py-3.5 sm:px-4 md:px-4 whitespace-nowrap text-xs font-medium">Employee Name</th>
                      <th className="text-left py-3 px-2 sm:py-3.5 sm:px-4 md:px-4 hidden sm:table-cell whitespace-nowrap text-xs font-medium">Employee ID</th>
                      <th className="text-left py-3 px-2 sm:py-3.5 sm:px-4 md:px-4 hidden lg:table-cell whitespace-nowrap text-xs font-medium">Department</th>
                      <th className="text-left py-3 px-2 sm:py-3.5 sm:px-4 md:px-4 whitespace-nowrap text-xs font-medium">Leave Type</th>
                      <th className="text-left py-3 px-2 sm:py-3.5 sm:px-4 md:px-4 hidden md:table-cell whitespace-nowrap text-xs font-medium">From</th>
                      <th className="text-left py-3 px-2 sm:py-3.5 sm:px-4 md:px-4 hidden md:table-cell whitespace-nowrap text-xs font-medium">To</th>
                      <th className="text-left py-3 px-2 sm:py-3.5 sm:px-4 md:px-4 hidden xl:table-cell whitespace-nowrap text-xs font-medium">Reason</th>
                      <th className="text-left py-3 px-2 sm:py-3.5 sm:px-4 md:px-4 whitespace-nowrap text-xs font-medium">Days</th>
                      <th className="text-left py-3 px-2 sm:py-3.5 sm:px-4 md:px-4 whitespace-nowrap text-xs font-medium">Status</th>
                      <th className="text-center py-3 px-2 sm:py-3.5 sm:px-4 md:px-4 whitespace-nowrap text-xs font-medium sticky right-0 bg-white z-10">Action</th>
                    </tr>
                  </thead>
                  <tbody>
                    {paginatedLeaves.length > 0 ? (
                      paginatedLeaves.map((leave) => (
                        ...
                        >
                          <td className="py-2 px-2 sm:py-3.5 sm:px-4 font-medium text-slate-900 text-xs sm:text-sm whitespace-nowrap">
                            {leave.employeeName}
                          </td>
                          <td className="py-2 px-2 sm:py-3.5 sm:px-4 text-slate-600 hidden sm:table-cell text-xs sm:text-sm whitespace-nowrap">
                            {leave.employeeId}
                          </td>
                          <td className="py-2 px-2 sm:py-3.5 sm:px-4 text-slate-600 hidden lg:table-cell text-xs sm:text-sm whitespace-nowrap">
                            {leave.department || '-'}
                          </td>
                          <td className="py-2 px-2 sm:py-3.5 sm:px-4 text-slate-600 text-xs sm:text-sm whitespace-nowrap">
                            {leave.leaveType}
                          </td>
                          <td className="py-2 px-2 sm:py-3.5 sm:px-4 text-slate-600 hidden md:table-cell text-xs sm:text-sm whitespace-nowrap">
                            {formatDate(leave.fromDate)}
                          </td>
                          <td className="py-2 px-2 sm:py-3.5 sm:px-4 text-slate-600 hidden md:table-cell text-xs sm:text-sm whitespace-nowrap">
                            {formatDate(leave.toDate)}
                          </td>
                          <td className="py-2 px-2 sm:py-3.5 sm:px-4 text-slate-500 hidden xl:table-cell text-xs sm:text-sm max-w-[150px] truncate" title={leave.reason}>
                            {leave.reason || '-'}
                          </td>
                          <td className="py-2 px-2 sm:py-3.5 sm:px-4 text-slate-600 text-xs sm:text-sm whitespace-nowrap">
                            {leave.numberOfDays || '-'}
                          ...
                          <td className="py-2 px-2 sm:py-3.5 sm:px-4 text-center sticky right-0 bg-white z-10">
                            <button
        ...
        {!loading && !error && leaves.length === 0 && (
          <Card>
            <CardContent className="pt-4 md:pt-6">
              <div className="text-center py-6 md:py-8">
                <p className="text-xs md:text-sm text-slate-500">No leave requests to display</p>
              </div>
            </CardContent>
          </Card>
        )}
      ...
      >
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <select
              className="w-full px-4 py-2.5 border border-slate-200 rounded-xl focus:ring-2 focus:ring-slate-900/10 focus:border-slate-400 focus:outline-none text-sm appearance-none bg-white transition-all"
              value={statusFilter}
              onChange={(e) => setStatusFilter(e.target.value)}
            >
          ...
          <div className="space-y-6">
            ...
            <div className="bg-slate-50 rounded-xl p-4 space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm font-medium text-slate-900">{editingLeave.employeeName}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm text-slate-500">Department</span>
                <span className="text-sm font-medium text-slate-900">{editingLeave.department || '-'}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm text-slate-500">Leave Type</span>
                <span className="text-sm font-medium text-slate-900">{editingLeave.leaveType}</span>
              </div>
              <div className="flex justify-between items-center">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm font-medium text-slate-900">{editingLeave.numberOfDays}</span>
              </div>
              {editingLeave.reason && (
              ...
              <>
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    ...
                    >
                      <Clock size={24} className={selectedStatus === 'Pending' ? 'text-yellow-600' : 'text-slate-400'} />
                      <span className={`text-sm mt-2 font-medium ${selectedStatus === 'Pending' ? 'text-yellow-700' : 'text-slate-600'}`}>
                        Pending
                      </span>
                    </button>
                    <button
                    ...
                    >
                      <CheckCircle size={24} className={selectedStatus === 'Approved' ? 'text-green-600' : 'text-slate-400'} />
                      <span className={`text-sm mt-2 font-medium ${selectedStatus === 'Approved' ? 'text-green-700' : 'text-slate-600'}`}>
                        Approve
                      </span>
                    </button>
                    <button
                    ...
                    >
                      <XCircle size={24} className={selectedStatus === 'Rejected' ? 'text-red-600' : 'text-slate-400'} />
                      <span className={`text-sm mt-2 font-medium ${selectedStatus === 'Rejected' ? 'text-red-700' : 'text-slate-600'}`}>
                        Reject
                      </span>
                    </button>
                  </div>
              ...
              <div className="bg-slate-100 rounded-xl p-4 text-center">
                ...
                {editingLeave.rejectionReason && (
                  <div className="mt-3 pt-3 border-t border-slate-200 text-left">
                    ...
                    <p className="text-sm text-slate-700 mt-1">{editingLeave.rejectionReason}</p>
                  </div>
                )}
              </div>
            )}
