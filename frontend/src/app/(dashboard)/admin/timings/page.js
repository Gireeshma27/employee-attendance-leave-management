    ...
    <DashboardLayout role="admin">
      <div className="space-y-6 md:space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
          <div>
            <h1 className="text-lg sm:text-2xl md:text-3xl font-bold text-gray-900">Timings</h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="flex items-end lg:col-span-2 gap-2">
              <button
                ...
                className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:ring-4 focus:ring-gray-100 transition-all h-[42px]"
              >
                Clear Filters
              </button>
            </div>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="text-center py-8">
                ...
                <p className="text-gray-600">Loading timings...</p>
              </div>
            </CardContent>
          </Card>
        )}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
            <Card className="hover:shadow-md transition-shadow border-gray-100">
              <CardContent className="pt-6 text-center">
                ...
                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Total Timings</p>
                <p className="text-3xl font-bold text-gray-900 mt-2 tracking-tight">{totalTimings}</p>
              </CardContent>
            </Card>
            <Card className="hover:shadow-md transition-shadow border-gray-100">
              <CardContent className="pt-6 text-center">
                ...
                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Active Schedules</p>
                <p className="text-3xl font-bold text-green-600 mt-2 tracking-tight">{activeTimings}</p>
              </CardContent>
            </Card>
            <Card className="hover:shadow-md transition-shadow border-gray-100">
              <CardContent className="pt-6 text-center">
                ...
                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Departments Covered</p>
                <p className="text-3xl font-bold text-purple-600 mt-2 tracking-tight">{totalDepartmentsCovered}</p>
              </CardContent>
            </Card>
          </div>
        )}
                  ...
                  <table className="w-full text-sm text-left">
                    <thead className="bg-gray-50/80 border-b border-gray-200">
                      <tr className="text-gray-500 font-semibold uppercase tracking-wider text-xs">
                        ...
                        <th className="py-4 px-6 text-center whitespace-nowrap sticky right-0 bg-gray-50/80 z-10">
                          Actions
                        </th>
                      </tr>
                    </thead>
                        ...
                        >
                          <td className="py-4 px-6 whitespace-nowrap">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="font-medium text-gray-900">{timing.location}</span>
                            </div>
                          </td>
                          <td className="py-4 px-6 text-gray-600 whitespace-nowrap">{timing.branch}</td>
                          <td className="py-4 px-6 whitespace-nowrap">
                            <span className="font-medium text-gray-900">{timing.teamName}</span>
                          </td>
                          <td className="py-4 px-6 whitespace-nowrap">
                            <div className="flex items-center gap-1.5">
                              <Clock size={14} className="text-green-500" />
                              <span className="font-mono text-sm font-medium text-gray-700">{timing.loginTime}</span>
                            </div>
                          </td>
                          <td className="py-4 px-6 whitespace-nowrap">
                            <div className="flex items-center gap-1.5">
                              <Clock size={14} className="text-red-500" />
                              <span className="font-mono text-sm font-medium text-gray-700">{timing.logoutTime}</span>
                            </div>
                          </td>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">No Timings Found</h3>
