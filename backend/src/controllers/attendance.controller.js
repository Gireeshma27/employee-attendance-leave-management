...
export const checkOut = async (req, res) => {
  try {
    ...
    const workingHours = Math.round((workingMilliseconds / (1000 * 60 * 60)) * 2) / 2; // Round to nearest 0.5
...
export default { checkIn, checkOut, getMyAttendance, getTeamAttendance, generateReport };
